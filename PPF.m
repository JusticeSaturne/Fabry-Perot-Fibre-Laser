function PP = PPF(z,pp,psf,psb)
% PPF function represents forward pump field propagation equation
% 
% Inputs:
...
%  
% Outputs: 
%   PP: Forward pump power as a function of distance z
%  
% Comments:
...
% Check inputs
if nargin <4
    error(message('MATLAB:PPF:NotEnoughInputs'));
end
...
PP= (pp.*Gammap).*(sigma21P*N2-sigma12P*N1)+(alphap.*pp);
