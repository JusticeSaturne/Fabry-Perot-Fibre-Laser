function PF = PSF(z,pp,psf,psb)
% PSF function represents forward laser field propagation equation
% 
% Inputs:
...
%  
% Outputs: 
%   PF : Forward signal power as a function of distance z
%  
% Comments:
...
% Check inputs
if nargin <4
    error(message('MATLAB:PSF:NotEnoughInputs'));
end
...
PF= (psf.*Gammas).*(sigma21S*N2-sigma12S*N1)-(alphas.*psf);